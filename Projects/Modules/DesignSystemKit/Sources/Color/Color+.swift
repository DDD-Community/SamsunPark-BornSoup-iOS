...
public extension Color {
    ...
    static let main4 = Color(hex: 0xFFE57F, opacity: 1)
    static let main5 = Color(hex: 0xFFECB3, opacity: 1)
    static let main6 = Color(hex: 0xFFF8E1, opacity: 1)
    ...
    static let orangeGray3 = Color(hex: 0x736F6A, opacity: 1)
    static let orangeGray4 = Color(hex: 0x88847F, opacity: 1)
    static let orangeGray5 = Color(hex: 0xB2AEA9, opacity: 1)
    static let orangeGray6 = Color(hex: 0xD0CBC6, opacity: 1)
    static let orangeGray7 = Color(hex: 0xF1EDE8, opacity: 1)
    static let orangeGray8 = Color(hex: 0xF6F2ED, opacity: 1)
